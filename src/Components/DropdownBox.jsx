...
const DropdownBox = () => {
  ...
  return (
    <div className="relative" ref={exploreRef}>
      <button
        className="flex items-center gap-2 text-white text-xl md:text-2xl font-bold tracking-wide px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-500 rounded-full hover:from-indigo-500 hover:to-purple-600 focus:outline-none transition-all duration-300 shadow-lg"
